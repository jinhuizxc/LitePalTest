        ...
        switch (v.getId()) {
            case R.id.update_btn1:
                try {
                    ...
                    long updateId = Long.parseLong(mSingerIdEdit.getText().toString());
                    // 更新数据
                    int rowsAffected = DbHelper.update(singer, updateId);

                    Toast.makeText(this,
                            String.format(getString(R.string.number_of_rows_affected), String.valueOf(rowsAffected)),
